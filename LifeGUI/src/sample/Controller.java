...
public class Controller implements Initializable {
    ...
    @FXML
    private Button optionsBack, optionsCash, optionsDeck, cashSave, cashBack, deckSave, deckBack;
    ...
    public void handlePlay() throws Exception{
        ...
        Parent playerView = FXMLLoader.load(getClass().getResource("playerChoose.fxml"));
    ...
    public void handleOptions() throws Exception {
        ...
        Parent optionView = FXMLLoader.load(getClass().getResource("optionsMenu.fxml"));
    ...
    public void twoPlayerGame() throws Exception {
        ...
        Parent twoView = FXMLLoader.load(getClass().getResource("twoPlayers.fxml"));
    ...
    public void threePlayerGame() throws Exception {
        ...
        Parent threeView = FXMLLoader.load(getClass().getResource("threePlayers.fxml"));
    ...
    public void playerReturn() throws Exception {
        ...
        Parent pRView = FXMLLoader.load(getClass().getResource("mainMenu.fxml"));
    ...
    public void changeSize() throws Exception {
        ...
        Parent deckView = FXMLLoader.load(getClass().getResource("editDeck.fxml"));
    ...
    public void savedDeck() throws Exception {
        ...
        Parent dView = FXMLLoader.load(getClass().getResource("optionsMenu.fxml"));
    ...
    public void backDeck() throws Exception {
        ...
        Parent bView = FXMLLoader.load(getClass().getResource("optionsMenu.fxml"));
    ...
    public void changeCash() throws Exception {
        ...
        Parent cashView = FXMLLoader.load(getClass().getResource("editCashAmt.fxml"));
    ...
    public void savedCash() throws Exception {
        ...
        Parent cView = FXMLLoader.load(getClass().getResource("optionsMenu.fxml"));
    ...
    public void optionReturn() throws Exception {
        ...
        Parent returnView = FXMLLoader.load(getClass().getResource("mainMenu.fxml"));
